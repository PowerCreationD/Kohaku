...
import tech_agri_workshop_2 from '@/assets/image/work/content/tech-agri-workshop/2.jpg'
import tech_agri_workshop_3 from '@/assets/image/work/content/tech-agri-workshop/3.jpg'
import tech_agri_workshop_4 from '@/assets/image/work/content/tech-agri-workshop/4.jpg'

import lathe_tech_workshop_0 from '@/assets/image/work/content/lathe-tech-workshop/0.jpg'
import lathe_tech_workshop_1 from '@/assets/image/work/content/lathe-tech-workshop/1.jpg'
import lathe_tech_workshop_2 from '@/assets/image/work/content/lathe-tech-workshop/2.jpg'
import lathe_tech_workshop_3 from '@/assets/image/work/content/lathe-tech-workshop/3.jpg'

import digital_craft_platform_0 from '@/assets/image/work/content/digital-craft-platform/0.png'
...
import supermarket_japan_station_2 from '@/assets/image/work/content/supermarket-japan-station/2.jpg'
import supermarket_japan_station_3 from '@/assets/image/work/content/supermarket-japan-station/3.jpg'
import supermarket_japan_station_4 from '@/assets/image/work/content/supermarket-japan-station/4.jpg'
import supermarket_japan_station_5 from '@/assets/image/work/content/supermarket-japan-station/5.jpg'
import supermarket_japan_station_6 from '@/assets/image/work/content/supermarket-japan-station/6.jpg'
import supermarket_japan_station_7 from '@/assets/image/work/content/supermarket-japan-station/7.jpg'
import supermarket_japan_station_8 from '@/assets/image/work/content/supermarket-japan-station/8.jpg'

import pingtung_pineapple_export_0 from '@/assets/image/work/content/pingtung-pineapple-export/0.jpg'
...
import mu_maison_2 from '@/assets/image/work/design/mu-maison/2.png'
import mu_maison_3 from '@/assets/image/work/design/mu-maison/3.png'
import mu_maison_4 from '@/assets/image/work/design/mu-maison/4.png'
import mu_maison_5 from '@/assets/image/work/design/mu-maison/5.png'

import recycled_pottery_furniture_0 from '@/assets/image/work/design/recycled-pottery-furniture/0.jpg'
import recycled_pottery_furniture_1 from '@/assets/image/work/design/recycled-pottery-furniture/1.jpg'
import recycled_pottery_furniture_2 from '@/assets/image/work/design/recycled-pottery-furniture/2.jpg'
import recycled_pottery_furniture_3 from '@/assets/image/work/design/recycled-pottery-furniture/3.jpg'
import recycled_pottery_furniture_4 from '@/assets/image/work/design/recycled-pottery-furniture/4.jpg'
import recycled_pottery_furniture_5 from '@/assets/image/work/design/recycled-pottery-furniture/5.jpg'
...
export default {
      ...
      workItems: [
        {
          ...
          collaborator: this.$t('work.projects[1].collaborator'),
          name: this.$t('work.projects[1].name'),
          layoutType: 3,
          content: this.$t('work.projects[1].content'),
          keywords: [
            this.$t('work.projects[1].keywords[0]'),
            this.$t('work.projects[1].keywords[1]'),
            this.$t('work.projects[1].keywords[2]')
          ],
          images: [
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[2].collaborator'),
          name: this.$t('work.projects[2].name'),
          layoutType: 2,
          content: this.$t('work.projects[2].content'),
          keywords: [
            this.$t('work.projects[2].keywords[0]'),
            this.$t('work.projects[2].keywords[1]'),
            this.$t('work.projects[2].keywords[2]'),
            this.$t('work.projects[2].keywords[3]')
          ],
          images: [
            { index: 0, path: tech_agri_workshop_0, fileName: '0.jpg' },
            { index: 1, path: tech_agri_workshop_1, fileName: '1.jpg' },
            { index: 2, path: tech_agri_workshop_2, fileName: '2.jpg' },
            { index: 3, path: tech_agri_workshop_3, fileName: '3.jpg' },
            { index: 4, path: tech_agri_workshop_4, fileName: '4.jpg' }
          ]
        },
        {
          id: 3,
          ...
          collaborator: this.$t('work.projects[3].collaborator'),
          name: this.$t('work.projects[3].name'),
          layoutType: 6,
          content: this.$t('work.projects[3].content'),
          keywords: [
            this.$t('work.projects[3].keywords[0]'),
            this.$t('work.projects[3].keywords[1]'),
            this.$t('work.projects[3].keywords[2]')
          ],
          images: [
            { index: 0, path: lathe_tech_workshop_0, fileName: '0.jpg' },
            { index: 1, path: lathe_tech_workshop_1, fileName: '1.jpg' },
            { index: 2, path: lathe_tech_workshop_2, fileName: '2.jpg' },
            { index: 3, path: lathe_tech_workshop_3, fileName: '3.jpg' }
          ]
        },
        {
          id: 4,
          ...
          collaborator: this.$t('work.projects[4].collaborator'),
          name: this.$t('work.projects[4].name'),
          layoutType: 3,
          content: this.$t('work.projects[4].content'),
          keywords: [
            this.$t('work.projects[4].keywords[0]'),
            this.$t('work.projects[4].keywords[1]'),
            this.$t('work.projects[4].keywords[2]'),
            this.$t('work.projects[4].keywords[3]')
          ],
          images: [
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[5].collaborator'),
          name: this.$t('work.projects[5].name'),
          layoutType: 6,
          content: this.$t('work.projects[5].content'),
          keywords: [
            this.$t('work.projects[5].keywords[0]'),
            this.$t('work.projects[5].keywords[1]'),
            this.$t('work.projects[5].keywords[2]')
          ],
          images: [
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[6].collaborator'),
          name: this.$t('work.projects[6].name'),
          layoutType: 4,
          content: this.$t('work.projects[6].content'),
          keywords: [
            this.$t('work.projects[6].keywords[0]'),
            this.$t('work.projects[6].keywords[1]')
          ],
          images: [
            { index: 0, path: supermarket_japan_station_0, fileName: '0.jpg' },
            { index: 1, path: supermarket_japan_station_1, fileName: '1.jpg' },
            { index: 2, path: supermarket_japan_station_2, fileName: '2.jpg' },
            { index: 3, path: supermarket_japan_station_3, fileName: '3.jpg' },
            { index: 4, path: supermarket_japan_station_4, fileName: '4.jpg' },
            { index: 5, path: supermarket_japan_station_5, fileName: '5.jpg' },
            { index: 6, path: supermarket_japan_station_6, fileName: '6.jpg' },
            { index: 7, path: supermarket_japan_station_7, fileName: '7.jpg' },
            { index: 8, path: supermarket_japan_station_8, fileName: '8.jpg' }
          ]
        },
        {
          id: 7,
          ...
          keywords: [
            ...
            this.$t('work.projects[7].keywords[1]')
          ],
          images: [
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[8].collaborator'),
          name: this.$t('work.projects[8].name'),
          layoutType: 3,
          content: this.$t('work.projects[8].content'),
          keywords: [
            this.$t('work.projects[8].keywords[0]'),
            this.$t('work.projects[8].keywords[1]')
          ],
          images: [
            { index: 0, path: mu_maison_0, fileName: '0.png' },
            { index: 1, path: mu_maison_1, fileName: '1.png' },
            { index: 2, path: mu_maison_2, fileName: '2.png' },
            { index: 3, path: mu_maison_3, fileName: '3.png' },
            { index: 4, path: mu_maison_4, fileName: '4.png' },
            { index: 5, path: mu_maison_5, fileName: '5.png' }
          ]
        },
        {
          id: 9,
          ...
          collaborator: this.$t('work.projects[9].collaborator'),
          name: this.$t('work.projects[9].name'),
          layoutType: 4,
          content: this.$t('work.projects[9].content'),
          keywords: [
            this.$t('work.projects[9].keywords[0]'),
            this.$t('work.projects[9].keywords[1]'),
            this.$t('work.projects[9].keywords[2]'),
            this.$t('work.projects[9].keywords[3]')
          ],
          images: [
            { index: 0, path: recycled_pottery_furniture_0, fileName: '0.jpg' },
            { index: 1, path: recycled_pottery_furniture_1, fileName: '1.jpg' },
            { index: 2, path: recycled_pottery_furniture_2, fileName: '2.jpg' },
            { index: 3, path: recycled_pottery_furniture_3, fileName: '3.jpg' },
            { index: 4, path: recycled_pottery_furniture_4, fileName: '4.jpg' },
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[10].collaborator'),
          name: this.$t('work.projects[10].name'),
          layoutType: 6,
          content: this.$t('work.projects[10].content'),
          keywords: [
            this.$t('work.projects[10].keywords[0]'),
            this.$t('work.projects[10].keywords[1]'),
            this.$t('work.projects[10].keywords[2]')
          ],
          images: [
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[11].collaborator'),
          name: this.$t('work.projects[11].name'),
          layoutType: 5,
          content: this.$t('work.projects[11].content'),
          keywords: [
            this.$t('work.projects[11].keywords[0]'),
            this.$t('work.projects[11].keywords[1]')
          ],
          images: [
            { index: 0, path: power_creation_business_card_0, fileName: '0.jpg' },
            { index: 1, path: power_creation_business_card_1, fileName: '1.jpg' }
          ]
        },
        {
          id: 12,
          ...
          collaborator: this.$t('work.projects[12].collaborator'),
          name: this.$t('work.projects[12].name'),
          layoutType: 5,
          content: this.$t('work.projects[12].content'),
          keywords: [
            this.$t('work.projects[12].keywords[0]'),
            this.$t('work.projects[12].keywords[1]')
          ],
          images: [
            { index: 0, path: japan_gov_business_card_0, fileName: '0.jpg' },
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[14].collaborator'),
          name: this.$t('work.projects[14].name'),
          layoutType: 1,
          content: this.$t('work.projects[14].content'),
          keywords: [
            this.$t('work.projects[14].keywords[0]'),
            this.$t('work.projects[14].keywords[1]')
          ],
          images: [
            { index: 0, path: leek_kimchi_packaging_0, fileName: '0.jpg' },
            { index: 1, path: leek_kimchi_packaging_1, fileName: '1.jpg' },
            { index: 2, path: leek_kimchi_packaging_2, fileName: '2.jpg' }
          ]
        },
        {
          id: 15,
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[16].collaborator'),
          name: this.$t('work.projects[16].name'),
          layoutType: 2,
          content: this.$t('work.projects[16].content'),
          keywords: [
            this.$t('work.projects[16].keywords[0]'),
            this.$t('work.projects[16].keywords[1]'),
            this.$t('work.projects[16].keywords[2]')
          ],
          images: [
            { index: 0, path: auto_robot_control_platform_0, fileName: '0.jpg' },
            { index: 1, path: auto_robot_control_platform_1, fileName: '1.jpg' },
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[17].collaborator'),
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[19].collaborator'),
          name: this.$t('work.projects[19].name'),
          layoutType: 5,
          content: this.$t('work.projects[19].content'),
          keywords: [
            this.$t('work.projects[19].keywords[0]'),
            this.$t('work.projects[19].keywords[1]')
          ],
          images: [
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[24].collaborator'),
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[25].collaborator'),
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[26].collaborator'),
        ...
        },
        {
          ...
          collaborator: this.$t('work.projects[27].collaborator'),
  ...
  methods: {
    shouldShowImage(fileName) {
      if (this.project !== 'japan-agri-ecom-logistics') return true

      if (!this.mobileCheck.value) {
        return fileName.includes('web')
      } else {
    ...
    findWorkByProject(projectName) {
      const result = this.workItems.find((item) => item.project === projectName)
