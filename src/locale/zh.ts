  ...
  work: {
    ...
    projects: {
      ...
      21: {
        ...
        concept: '品牌形象識別',
        client: 'アクト中食株式会社',
        content: `與日商公司合作，為日本米進行包裝設計。以日系簡約風格為主軸，從紙質的挑選到視覺的設計，都圍繞在純淨與自然之間，精心雕琢每個細節，呈現出高品質與獨特的美感，以獨具匠心的設計作為日本米的品質詮釋。`,
        keywords: ['包裝設計', '視覺設計']
      },
      22: {
        name: '台日香蕉試食會',
        concept: '整合行銷企劃',
        client: '弘運物產開發公司、アクト中食株式会社',
      ...
      27: {
        ...
        concept: '機電整合開發',
        client: '欣奇農場',
        content: `與高雄在地農民合作進行農機開發，主要用於木瓜網室噴灑農藥情境。具有模組化設計，可用於農藥噴灑，也可在卸下作為搬運車使用。可遠距遙控或搖桿控制，並具有三段式速度控制。噴灑功能整合雙水泵供應系統和廣角噴片，提高效率和覆蓋範圍。透過在農業生產端導入智慧化農機具，有效提升農民朋友的工作效率與工作品質。影片連結：https://youtu.be/hmpxN4J3Os8?si=Dpjam4J13jXvEPgF`,
      ...
      28: {
        ...
        client: '沃畝股份有限公司',
        content: `與沃畝股份有限公司合作，開發一套整合LINE Bot、Google Apps Script和Google Sheets的系統，專為植物水分測量系統的資料即時監測而設計。該系統能自動讀取Google Sheets上的資料，並即時傳送給已綁定的LINE Bot用戶，用戶亦可主動獲取最新資料。透過該系統，用戶可以方便地利用手機收取植物水分測量資訊，大幅增加資料傳遞的即時性。`,
