const locale = {
    ...
    homepage: {
        slogan: '想像 × 創造 × 未来',
        description: ['本舞台は常に将来にあり、私たちは最適なデザインと技術でビジネス課題を解決する。', '経験分野は食と農業、製造と工芸、地方課題'],
        research: {
            title: 'RESEARCH  理解の深さ',
            subtitle: '根本の課題とニーズを洞察する',
            text: ['琥白は、大量の研究に基づき、顧客の意図をサポートします。', '望む変革を実現するために、着実な条件を考慮します。']
        },
        concept: {
            title: 'CONCEPT  思考の広さ',
            subtitle: '既存の枠にとらわれない領域横断的なコンセプト',
            text: ['琥白のメンバーは、さまざまな専門知識のバックグラウンドを持っています。', '顧客と革新的なコンセプトを多角的に議論します。']
        },
        solutions: {
            ...
            system: {
                name: 'システム設計 / 開発と運用',
                shortName: 'システム開発',
                subtitleSentences: ['お客様の要望によって、システム構築し、', '将来の展望を築くためのサポートを提供いたします'],
                textSentences: [
            ...
            product: {
                name: 'プロダクトデザイン',
                shortName: 'プロダクトデザイン',
                subtitleSentences: ['既存の製品の問題点を突き込んで', '世の中の動向やトレンドを把握しつつ、斬新なデザインで痛点を解消していく'],
                textSentences: [
                    'ユーザー視点から機能と形を考え、',
                    '繊細なデザインで製品を仕上げていきます。'
                ],
            ...
            design: {
                ...
                subtitleSentences: ['一つのデザインで、お客様の商品の魅力を作り出して', 'ブランドの可能性を呼び起こすＦ'],
                textSentences: [
                ...
                projects: [
                    {
                        ...
                        description:
                            `農産品流通日本企業「やさいバス（Vegibus）」と連携し、地産地消の持続可能な供給を推進しています。やさいバスシステムでは、生産地の供給、配送状況、注文と支払い情報を一元化し、複雑な物流プロセスにおいて、複数の農家からの商品受け取り、集荷、沿線での配送を効率的に実現しました。
                    ...
                    },
                    {
                        ...
                        description:
                            `モバイルムーバー（Mobile Mover）は、屋外作業用のモビリティです。高齢化による農業労働力の急激な減少という地域の課題に対処するため、エムスクエア・ラボとスズキが共同で開発し、操作インタフェースを琥白に依頼しました。
                ...
                projects: [
                    {
                        name: 'ブックデザイン｜木工技術の本',
                        description:
                            `国立台湾工芸研究開発センターとコラボし、職人にいる現場を実際に伺い、機械操作の映像や口述の情報を収集しました。そして職人の50年間の技術の粋をこの本にまとめ、政府の出版物として出版しました。
                ...
                projects: [
                    {
                        ...
                        description:
                            `国立台湾工芸研究開発センターとコラボし、現地で映像や口述の情報を収集し、職人の50年間の技術の精華を記録させていただきました。映像編集や映像記録は、活動終了日に上映され、活動の締めくくりとして使用されていました。
    ...
    services: {
        system: {
            name: "システム設計 / 開発と運用",
            slogan: ["お客様の要望によって、システム構築し、", "将来の展望を築くためのサポートを提供いたします"],
            description: "SaaS（Software as a Service）のソフトウェアサービスから、お客様のご要件に応じて最適なシステムを構築し、業務プロセスを効率化いたします。",
            content: [
                {
                    title: "システム開発",
                    services: [
            ...
            works_example: ["生産・販売統合システム｜日本農産のBtoB物流サービス", "ロボット台車開発｜自動移動ロボットの操作インタフェース"]
        },
        trading: {
            name: "国際貿易サービス",
            slogan: ["台湾の美味しい食文化の発掘し", "国際を向けて歩み出す"],
            description: "台湾と日本の農産物および食品の双方向の供給と販売、さらに農業機械の代理サービスを提供し、MIT(Made in Taiwan)を世界に立ち上げるように、対象國の輸入輸出の商品相談 / 消費習慣に合わせたブランドパッケージ作成 / 輸出代行などのサービスを提供しています。",
            content: [
                {
                    title: "輸入輸出  / 国際貿易",
                    services: [
        ...
        product: {
            name: "プロダクトデザイン",
            slogan: ["既存の製品の問題点を突き込んで", "世の中の動向やトレンドを把握しつつ、斬新なデザインで痛点を解消していく"],
        ...
        planning: {
            ...
            description: "お客様の要望によって、外部のチームとコラボし、研修、イベント、展示会に対するのサービスを提供しております。",
            content: [
                {
                    title: "企画活動",
                    services: [
